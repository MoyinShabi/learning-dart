void main(List<String> args) {
  ...
  // The `map()` method
  final multiply = listOfInts.map((value) => 'M: ${value * 3}');
  print('--8--');
  print(multiply);
...
// Declaring a function as the first argument (parameter), called `greet` of the type `Function`, which takes (must take) a `String` argument itself, and returns (must return) a `String` also.
  print(greet(name));
...
need to name it. An in any case, you can always refactor it into a typedef later. */
